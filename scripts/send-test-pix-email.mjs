...
const userId = 1411418;
const name = 'Marcos Gervazoni';
const email = 'marcos.gervazoni@gmail.com';
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#121826;border-radius:12px;overflow:hidden;max-width:600px;">
        ...
        <tr><td style="padding:40px;">
          <p style="color:#F5F5F5;font-size:18px;font-weight:700;margin:0 0 8px;">Olá, ${name}! 👋</p>
...
await conn.query(
  ...
  [userId, email, subject, html, 'pending']
);
console.log(`✅ E-mail de teste enfileirado para: ${name} <${email}>`);
await conn.end();
